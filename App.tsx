...
function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-cyan-500/30 overflow-x-hidden relative bg-zinc-950 text-zinc-100">
      ...
      <section className="relative pt-28 pb-10 md:pt-40 md:pb-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col gap-12 lg:gap-24">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <div className="space-y-8 relative order-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-[1.1] relative z-10 text-white">
                ...
                <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">WhatsApp</span> con IA
              </h1>
              
              <p className="text-lg text-zinc-400 max-w-xl leading-relaxed relative z-10">
              ...
              <div className="flex items-center gap-4 text-sm text-zinc-500 pt-8 border-t border-white/5 mt-8 relative z-10">
          ...
          <div className="relative w-full max-w-6xl mx-auto" id="soluciones">
             <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/10 to-blue-500/10 rounded-[2.5rem] blur-3xl -z-10 opacity-50"></div>
             
             {/* Componente Interactivo de Demos */}
             <div className="glass-card rounded-[2.5rem] p-6 md:p-12 overflow-hidden min-h-[600px] flex flex-col relative animate-float bg-zinc-900/40">
                <div className="text-center mb-10 relative z-10">
                    <h3 className="text-white font-display font-bold text-3xl mb-2">Elige tu Industria</h3>
                    <p className="text-zinc-400 text-base">Mira cómo Sigho AI interactúa con tus clientes en tiempo real</p>
                </div>
      ...
      {/* Features Grid */}
      <section className="py-24 px-6 relative z-10 bg-zinc-950/50" id="beneficios">
